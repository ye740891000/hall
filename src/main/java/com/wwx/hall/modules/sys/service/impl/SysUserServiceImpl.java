...
import com.wwx.hall.modules.sys.dao.SysUserDao;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserDao, SysUserEntity> implements SysUserService {
	...
	@Override
	public List<Long> queryAllHallId(Long userId) {
		return baseMapper.queryAllHallId(userId);
	}
	@Override
